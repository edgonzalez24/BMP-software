	...
	<JetFormSection @submitted="updatePassword">
		...
		<template #form>
			<div class="col-span-6 sm:col-span-4">
				...
				<JetInput id="current_password" ref="currentPasswordInput" v-model="form.current_password" type="password"
			...
			<div class="col-span-6 sm:col-span-4">
				...
				<JetInput id="password" ref="passwordInput" v-model="form.password" type="password" class="mt-1 block w-full"
